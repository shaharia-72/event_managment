...
SECRET_KEY = 'django-insecure-&m+c4p3##af80l47%9=n7^d*jk5ca$w=tou4lq+^f1-)zv=^b2'
...
INSTALLED_APPS = [
    ...
    'crispy_forms',  # Add crispy_forms once
    'crispy_bootstrap5',  # Ensure crispy_bootstrap5 is listed correctly
    'widget_tweaks',
    'accounts',
    'core',
    'events',
